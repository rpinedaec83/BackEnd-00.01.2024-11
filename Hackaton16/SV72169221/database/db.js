...
con.connect(function (err) {
    ...
    var sql = "CREATE TABLE IF NOT EXISTS  Pagos (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,id_pago VARCHAR(2550) ,correo VARCHAR(2550),producto VARCHAR(2550),Precio INT(6))";
    con.query(sql, function (err, result) {
        if (err) throw err;
    });
});
